...
package com.wuc656.nowinandroid.feature.topic.impl
...
import com.wuc656.nowinandroid.core.designsystem.component.NiaFilterChip
import com.wuc656.nowinandroid.core.designsystem.component.NiaLoadingWheel
...
import com.wuc656.nowinandroid.core.ui.DevicePreviews
import com.wuc656.nowinandroid.core.ui.TrackScreenViewEvent
import com.wuc656.nowinandroid.core.ui.TrackScrollJank
import com.wuc656.nowinandroid.core.ui.UserNewsResourcePreviewParameterProvider
import com.wuc656.nowinandroid.core.ui.rememberTranslatedDescription
import com.wuc656.nowinandroid.core.ui.rememberTranslatedName
import com.wuc656.nowinandroid.core.ui.rememberTranslatedUiString
import com.wuc656.nowinandroid.core.ui.userNewsResourceCardItems
import com.wuc656.nowinandroid.core.ui.R as UiR
import com.wuc656.nowinandroid.feature.topic.api.R as TopicR
...
private fun TopicHeader(name: String, description: String, imageUrl: String) {
    Column(
        ...
        Text(rememberTranslatedName(name), style = MaterialTheme.typography.displayMedium)
        if (description.isNotEmpty()) {
            Text(
                rememberTranslatedDescription(description),
...
private fun TopicToolbar(
    ...
    Row(
        ...
        NiaFilterChip(
            ...
            if (selected) {
                Text(rememberTranslatedUiString("FOLLOWING"))
            } else {
                Text(rememberTranslatedUiString("NOT FOLLOWING"))
            }
        }
    }
}
